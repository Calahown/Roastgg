...
MIDDLEWARE_CLASSES = [
    ...
    'sixerrapp.middleware.last_activity.LastUserActivityMiddleware',
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'sixerrapp.template_processors.category_names',
            ],
        },
    },
]
...
SOCIAL_AUTH_STRIPE_KEY = os.environ['SOCIAL_AUTH_STRIPE_KEY']
SOCIAL_AUTH_STRIPE_SECRET = os.environ['SOCIAL_AUTH_STRIPE_SECRET']
SOCIAL_AUTH_STRIPE_SCOPE = ['read_write']
ENDPOINT_SECRET = os.environ['ENDPOINT_SECRET']
# Stripe publishable key for Stripe Elements
STRIPE_PUBLISHABLE_KEY = os.environ['STRIPE_PUBLISHABLE_KEY']

GA_TRACKING_ID = os.environ['GA_TRACKING_ID']
TAXJAR_KEY = os.environ['TAXJAR_KEY']

SOCIAL_AUTH_STRIPE_PIPELINE = (
...
# Limits
MAX_GIG_PRICE = 500 # dollars
IDLE_MINUTES_CONSIDERED_LOGGED = 4 # minutes
# For middleware last_activity
LAST_ACTIVITY_INTERVAL_SECS = 120 # seconds

# List of Taxjar AND Stripe available countries
AVAILABLE_PLACES = [
    ("AT", "Austria", [
        ("", "region1", [
            ("", "city1"),
